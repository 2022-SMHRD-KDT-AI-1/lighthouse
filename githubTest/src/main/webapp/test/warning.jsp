...
html.invert {
	...
	.mediaViewInfo {
		--web-view-name: Warning;
		--web-view-id: Warning;
		--web-scale-on-resize: true;
		--web-enable-deep-linking: true;
	}
	:root {
		--web-view-ids: Warning;
	}
	* {
		margin: 0;
		padding: 0;
	...
	#Area_DISPLAY_ELEMENTSLabelSIZE_ {
		fill: rgba(75,101,135,1);
	}
	.Area_DISPLAY_ELEMENTSLabelSIZE_ {
		position: absolute;
...
<div id="Warning">
	...
	<svg class="n_11" viewBox="0 0 709 1">
		<path id="n_11" d="M 0 0 L 709 0">
		</path>
	</svg>
	<div id="n____">
	...
	<a href="ajaxTest.jsp">
	<div id="n_138">
		<svg class="Area_DISPLAY_ELEMENTSLabelSIZE_">
			<rect id="Area_DISPLAY_ELEMENTSLabelSIZE_" rx="0" ry="0" x="0" y="0" width="426.091" height="73.101">
			</rect>
		</svg>
		<div id="Label_">
			<span>메인화면으로</span>
	...
	<div id="List_Item_kf">
			...
			<div id="Label_kj">
				<button type='button' id='on' style="font-size: 1.1em;">고대비켜기</button>
			</div>
		</div>
		...
		<div id="List_Item_ka">
			...
			<div id="Label_ke">
				<button type='button' id='off' style="font-size: 1.1em;">고대비끄기</button>
			</div>
		</div>
		...
		<div id="List_Item">
			...
			<div id="Label_j">
				<button onClick="zoomIn();" style="font-size: 1.3em;">확대
					(+)</button>
			</div>
		</div>
		...
		<div id="List_Item_j">
			...
			<div id="Label_ka">
				<button onClick="zoomOut();" style="font-size: 1.3em;">축소
					(-)</button>
			</div>
		</div>
