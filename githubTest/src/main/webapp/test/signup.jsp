...
html.invert {
	...
	* {
	...
	.Check_DISPLAY_ELEMENTSLabelSTA {
		...
		width: 12.881px;
		height: 7.057px;
		transform: translate(-351px, -319px) matrix(1,0,0,1,406.1092,645.6017) rotate(-45deg);
	...
	#Area_DISPLAY_ELEMENTSDefaultST_u {
		fill: rgba(255,255,255,1);
	}
	.Area_DISPLAY_ELEMENTSDefaultST_u {
		position: absolute;
	...
	#Area_DISPLAY_ELEMENTSDefaultST_x {
		fill: rgba(255,255,255,1);
	}
	.Area_DISPLAY_ELEMENTSDefaultST_x {
		position: absolute;
...
<form action="JoinService" method="post" id="signup">
<div id="signup">
	<svg class="n_46">
	...
	<div id="n_73">
		<img id="n_512026" src="n_512026.png" srcset="n_512026.png 1x, n_512026@2x.png 2x">
		...
		<div id="n_72">
			...
			<div id="Label">
				<span onclick="document.getElementById('signup').submit(); alert('회원가입되었습니다. 로그인해주세요!');">회원가입</span>
				<!-- 회원가입(글자) span태그 누르기 !!!!!!!!!★ -->
			</div>
			...
			<div id="Value">
			<input type="password" name="pw" placeholder="비밀번호를 입력해주세요" style="font-size: 1.2em;">
			</div>
			
			
			<svg class="Area_DISPLAY_ELEMENTSDefaultST_x">
				<rect id="Area_DISPLAY_ELEMENTSDefaultST_x" rx="0" ry="0" x="0" y="0" width="426.091" height="72.261">
				</rect>
			</svg>
			
			
			<div id="Value_y">
				<input type="text" class="input_email" name="email" placeholder="아이디를 입력해주세요" style="font-size: 1.2em;">
			</div>
	...
	<div id="n_104">
		<div id="Circle_Button">
			...
			<svg class="Area_ba">
				<rect id="Area_ba" rx="25" ry="25" x="0" y="0" width="50" height="50">
				</rect>
			</svg>
			<div id="Icon">
				<div id="METADATA_bc">
				...
				<svg class="Area_bd">
					<rect id="Area_bd" rx="0" ry="0" x="0" y="0" width="31" height="31">
					</rect>
				</svg>
				<div id="Icon_be">
					<svg class="Path">
					...
					<svg class="Line_bh" viewBox="0 0 8.029 8.029">
						<path id="Line_bh" d="M 0 0 L 8.02882194519043 8.02882194519043">
						</path>
					</svg>
					<svg class="Line_bh" viewBox="0 0 8.029 8.029">
						<path id="Line_bh" d="M 0 0 L 8.02882194519043 8.02882194519043">
